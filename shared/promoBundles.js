...
export const PROMO_BUNDLES = Object.freeze([
  {
    ...
    pickupNote: "Phoenix yard pickup. Add Simon's Gold or Nature's Blanket from Products and check out together.",
    items: [
  ...
  },
  {
    ...
    savings: 98,
    badge: "Save $98",
    format: "16-bag Congress or delivery bundle",
    phoenixYardPickup: false,
    ...
    pickupNote: "PlantPal is not loading at the Phoenix yard right now. Choose Congress pickup or delivery at checkout. The three Nature's Blanket bags are included—already in this bundle price.",
    items: [
  ...
  },
  {
    ...
    lpUse: "Fill, feed, cover. Congress pickup or delivery.",
    description:
    ...
    savings: 167,
    badge: "Save $167",
    format: "40-bag Congress or delivery bundle",
    phoenixYardPickup: false,
    ...
    pickupNote: "PlantPal is not loading at the Phoenix yard right now. Choose Congress pickup or delivery at checkout.",
    items: [
