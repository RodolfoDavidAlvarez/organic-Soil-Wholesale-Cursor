...
function categoryRows(model) {
  return model.categories.map((category) => {
    ...
    return `<tr>
      <td style="padding:7px 10px 7px 0;color:#20221f;-webkit-text-fill-color:#20221f;font-size:12px;width:22%;">${escapeHtml(category.label)}</td>
      <td style="padding:7px 10px;width:56%;">
        <div style="height:7px;background:#d7d4cc;background-image:linear-gradient(#d7d4cc,#d7d4cc);border-radius:999px;width:${beforeWidth}%;margin-bottom:4px;"></div>
      ...
      <td align="right" style="padding:7px 0;color:#686b65;-webkit-text-fill-color:#686b65;font-size:12px;white-space:nowrap;width:22%;"><strong style="color:#8a5a12;-webkit-text-fill-color:#8a5a12;">${category.afterPercent.toFixed(0)}%</strong> ${deltaLabel(category.delta)}</td>
    </tr>`;
  }).join('');
}
...
function stageBlock(label, status, total) {
  ...
  return `<td valign="top" width="50%" style="padding:0 8px;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
      <tr><td style="padding-bottom:7px;color:#686b65;-webkit-text-fill-color:#686b65;font-size:12px;">${escapeHtml(label)}</td><td align="right" style="padding-bottom:7px;color:#686b65;-webkit-text-fill-color:#686b65;font-size:12px;">${total} profiles</td></tr>
...
function peopleRows(batch) {
  return batch.map((entry) => `<tr class="person-row">
    <td class="person-cell" valign="top" style="padding:11px 7px;border-top:1px solid #dedbd3;width:37%;overflow-wrap:anywhere;"><strong style="display:block;color:#20221f;-webkit-text-fill-color:#20221f;font-size:13px;">${escapeHtml(entry.full_name)}</strong><span style="display:block;margin-top:3px;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">${escapeHtml(entry.email)}</span></td>
    <td class="person-cell" valign="top" style="padding:11px 7px;border-top:1px solid #dedbd3;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;width:20%;white-space:nowrap;">${escapeHtml(entry.phone || 'Not provided')}</td>
    <td class="person-cell" valign="top" style="padding:11px 7px;border-top:1px solid #dedbd3;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;width:10%;">${escapeHtml(normalizeZip(entry.zip_code))}</td>
    <td class="person-cell" valign="top" style="padding:11px 7px;border-top:1px solid #dedbd3;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;width:33%;">${escapeHtml(quickView(entry))}</td>
  </tr>`).join('');
}
...
<style>:root{color-scheme:light only;supported-color-schemes:light}@media(max-width:560px){.email-pad{padding-left:16px!important;padding-right:16px!important}.kpi{display:block!important;width:100%!important;border-right:0!important;border-bottom:1px solid #dedbd3!important}.stage-cell{display:block!important;width:100%!important;padding:7px 0!important}.people-head{display:none!important}.person-row,.person-cell{display:block!important;width:100%!important}.person-row{padding:10px 0;border-top:1px solid #dedbd3}.person-cell{padding:3px 0!important;border:0!important;white-space:normal!important}}</style></head>
<body bgcolor="#efede8" style="margin:0;background:#efede8;background-image:linear-gradient(#efede8,#efede8);font-family:Arial,Helvetica,sans-serif;color:#20221f;-webkit-text-fill-color:#20221f;">
...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#efede8" style="background:#efede8;background-image:linear-gradient(#efede8,#efede8);"><tr><td align="center" style="padding:24px 10px;">
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:680px;background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);border:1px solid #d8d5cd;border-radius:16px;overflow:hidden;">
  ...
  <tr><td class="email-pad" bgcolor="#f4eee2" style="padding:27px 24px 23px;background:#f4eee2;background-image:linear-gradient(#f4eee2,#f4eee2);color:#20221f;-webkit-text-fill-color:#20221f;"><div style="color:#8a5a12;-webkit-text-fill-color:#8a5a12;font-size:12px;font-weight:700;letter-spacing:1.3px;text-transform:uppercase;">Big Garden Giveaway</div><h1 style="margin:7px 0 7px;color:#171916;-webkit-text-fill-color:#171916;font-size:29px;line-height:1.2;">SSW Lead Report #${model.batchNumber}</h1><p style="margin:0;color:#555852;-webkit-text-fill-color:#555852;font-size:15px;line-height:1.5;"><strong style="color:#20221f;-webkit-text-fill-color:#20221f;">This report covers the latest ${model.batchSize} giveaway lead submissions.</strong><br>Total leads since August: ${model.totalLeadsSinceAugust}.<br>Big Garden Giveaway leads since September: ${model.giveawayLeadsSinceSeptember}.</p></td></tr>
  <tr><td bgcolor="#ffffff" style="padding:0;background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
    <td class="kpi" width="33.33%" style="padding:17px 20px;border-right:1px solid #dedbd3;"><span style="display:block;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">Leads in this report</span><strong style="display:block;margin-top:4px;color:#8a5a12;-webkit-text-fill-color:#8a5a12;font-size:18px;">${model.batchSize}</strong></td>
    <td class="kpi" width="33.33%" style="padding:17px 20px;border-right:1px solid #dedbd3;"><span style="display:block;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">Total leads since August</span><strong style="display:block;margin-top:4px;color:#8a5a12;-webkit-text-fill-color:#8a5a12;font-size:18px;">${model.totalLeadsSinceAugust}</strong></td>
    <td class="kpi" width="33.33%" style="padding:17px 20px;"><span style="display:block;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">Giveaway since September</span><strong style="display:block;margin-top:4px;color:#8a5a12;-webkit-text-fill-color:#8a5a12;font-size:18px;">${model.giveawayLeadsSinceSeptember}</strong></td>
  </tr></table></td></tr>
  <tr><td class="email-pad" bgcolor="#ffffff" style="padding:24px;background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);border-top:1px solid #dedbd3;"><table role="presentation" width="100%"><tr><td><h2 style="margin:0;color:#20221f;-webkit-text-fill-color:#20221f;font-size:20px;">What profiled leads are growing</h2></td><td align="right" style="color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">${model.afterTotal} categorized profiles · all 9 categories</td></tr></table><p style="margin:8px 0 0;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;line-height:1.45;">Category insights use only leads who answered the growing questions; earlier leads are included in the headline total but not assumed here.</p><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:13px;">${categoryRows(model)}</table></td></tr>
  <tr><td class="email-pad" bgcolor="#f8f7f3" style="padding:24px;background:#f8f7f3;background-image:linear-gradient(#f8f7f3,#f8f7f3);border-top:1px solid #dedbd3;"><table role="presentation" width="100%"><tr><td><h2 style="margin:0;color:#20221f;-webkit-text-fill-color:#20221f;font-size:20px;">Gardening journey</h2></td><td align="right" style="color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">${model.baselineCount} prior profiles + ${model.endOrdinal} giveaway entrants</td></tr></table><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:14px;"><tr>${stageBlock('Before', model.beforeStatus, model.beforeTotal).replace('<td ', '<td class="stage-cell" ')}${stageBlock('Now', model.afterStatus, model.afterTotal).replace('<td ', '<td class="stage-cell" ')}</tr></table><p style="margin:11px 0 0;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;"><span style="color:#d5a143;-webkit-text-fill-color:#d5a143;">●</span> New or starting &nbsp;&nbsp; <span style="color:#898d86;-webkit-text-fill-color:#898d86;">●</span> Improving an existing garden</p></td></tr>
  <tr><td class="email-pad" bgcolor="#ffffff" style="padding:24px;background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);border-top:1px solid #dedbd3;"><table role="presentation" width="100%"><tr><td><h2 style="margin:0;color:#20221f;-webkit-text-fill-color:#20221f;font-size:20px;">Where the latest 30 leads are</h2></td><td align="right" style="color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">${escapeHtml(mapCaption)}</td></tr></table><img src="cid:${MAP_CONTENT_ID}" width="560" alt="Phoenix metro map showing the ${map.mappedPeople} leads in this report." style="display:block;width:100%;max-width:560px;height:auto;margin:15px auto 0;border:0;border-radius:12px;"></td></tr>
  <tr><td class="email-pad" bgcolor="#ffffff" style="padding:24px;background:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);border-top:1px solid #dedbd3;"><table role="presentation" width="100%"><tr><td><h2 style="margin:0;color:#20221f;-webkit-text-fill-color:#20221f;font-size:20px;">Latest ${model.batchSize} lead submissions</h2></td><td align="right" style="color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;">Contact details + quick context</td></tr></table><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:14px;table-layout:fixed;"><thead class="people-head"><tr><th align="left" style="padding:0 7px 9px;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;width:37%;">Person</th><th align="left" style="padding:0 7px 9px;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;width:20%;">Phone</th><th align="left" style="padding:0 7px 9px;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;width:10%;">ZIP</th><th align="left" style="padding:0 7px 9px;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;width:33%;">Quick view</th></tr></thead><tbody>${peopleRows(model.batch)}</tbody></table></td></tr>
  <tr><td class="email-pad" align="center" bgcolor="#f4f2ec" style="padding:17px 24px;background:#f4f2ec;background-image:linear-gradient(#f4f2ec,#f4f2ec);border-top:1px solid #dedbd3;color:#686b65;-webkit-text-fill-color:#686b65;font-size:11px;line-height:1.5;">Generated ${escapeHtml(phoenixTime(generatedAt))} AZ · ${model.baselineCount} profiled worm-castings signups included · Next report after lead ${nextTotal}</td></tr>
