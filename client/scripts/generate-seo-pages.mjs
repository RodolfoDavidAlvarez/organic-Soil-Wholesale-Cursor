...
const products = [
  ...
  },
  {
    ...
    slug: "soil-craft",
    title: "Soil Craft Premium Potting Soil",
    ...
    keywords: "organic potting soil, raised bed soil, container soil, nursery potting soil, Soil Craft, Phoenix potting soil",
    offers: [
      ["1.5 cu ft Bag", 15.99],
      ["Super Sack (2.2 cu yd)", 359.78],
      ["Truckload (~90 cu yd)", 5400],
    ],
  },
  {
...
const routes = [
  ...
  },
  {
    ...
    description: "Buy the four fastest pickup products online: dairy compost, worm castings, Soil Craft potting soil, and Nature's Blanket Premium mulch.",
