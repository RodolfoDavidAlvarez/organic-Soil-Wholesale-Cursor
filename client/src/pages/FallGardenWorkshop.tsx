      ...
      <section className="mx-auto grid max-w-6xl gap-9 px-5 py-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start lg:py-16">
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-[#d8e0d2] bg-white p-6 shadow-sm">
            <div className="flex items-start gap-3"><MapPin className="mt-1 h-6 w-6 shrink-0 text-primary" /><div><h2 className="font-heading text-2xl font-bold text-primary">Find the Phoenix yard</h2><p className="mt-2 leading-7 text-neutral-700"><strong>Organic Soil Wholesale</strong><br /><strong>1634 N 19th Ave, Phoenix, AZ 85009</strong><br />Use the south entrance from Grand Avenue and follow the yard lane to check-in.</p><div className="mt-3 flex flex-wrap gap-x-5 gap-y-2"><a className="font-semibold text-primary underline" href="https://www.google.com/maps/dir/?api=1&destination=33.467333%2C-112.101250">Open exact location pin</a><a href={CUSTOMER_SUPPORT_PHONE_TEL} aria-label={`Call ${CUSTOMER_SUPPORT_PHONE_DISPLAY}`} data-official-support-phone="true" data-phone-number={CUSTOMER_SUPPORT_PHONE_DIAL} data-callrail-ignore="true" data-dynamic-number-ignore="true" data-call-tracking-ignore="true" className="no-call-tracking font-semibold text-primary underline">Call <span data-official-support-phone-text="true">{CUSTOMER_SUPPORT_PHONE_DISPLAY}</span></a></div></div></div>
          </div>
        </div>
