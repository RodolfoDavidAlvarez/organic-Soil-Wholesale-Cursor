...
import { FileText, ClipboardList, LogOut, Calendar, Users, LayoutGrid, Settings } from 'lucide-react';
          ...
          <div className="px-4 md:px-6">
            <div className="flex gap-1 overflow-x-auto">
              ...
              <button
                ...
                className={`
                  flex items-center gap-2 px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap
                  ${location === '/admin/operations/tasks'
                    ? 'border-[#264027] text-[#264027]'
                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }
                `}
              ...
              <button
                onClick={() => navigate('/admin/operations/settings')}
                className={`
                  flex items-center gap-2 px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap
                  ${location === '/admin/operations/settings'
                    ? 'border-[#264027] text-[#264027]'
                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }
                `}
