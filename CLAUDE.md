...
- Use **(623) 263-3386** / **`tel:+16232633386`** as the sole official public customer support line for Organic Soil Wholesale / Soil Seed & Water.
- `(602) 637-0032` is retired. It must not appear in active source, generated output, environment configuration, structured data, CTAs, forms, templates, or tests.
...
- Canonical-number source and replacement procedure: `docs/PHONE_SOURCE_OF_TRUTH.md`.
