...
const server = await createServer({
  ...
  server: { host: '127.0.0.1', port: 5188, strictPort: true, fs: { allow: [fileURLToPath(new URL('..', import.meta.url)), '/Users/rodolfoalvarez/Documents/Soil Seed and Water/Organic Soil Wholesale/Organic Soil Wholesale Website'] }, proxy: { '/api': { target: 'https://www.organicsoilwholesale.com', changeOrigin: true }, '/uploads': { target: 'https://www.organicsoilwholesale.com', changeOrigin: true } } },
});
await server.listen();
console.log('Review preview: http://127.0.0.1:5188/landscaper-supply (live reads; submissions disabled)');
